...
@Api(value = "preview", description = "the preview API")
public interface PreviewApi {
    ...
    ResponseEntity<Resource> previewPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody PreviewRenderingRef body);
